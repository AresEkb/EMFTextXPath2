 ...
 */
public class Xpath2CodeFoldingManager {
	
	private class FoldingUpdateListener implements org.emftext.language.xpath2.resource.xpath2.IXpath2BackgroundParsingListener {
	...
	private class EditorOnCloseListener implements org.eclipse.ui.IPartListener2 {
		...
		public EditorOnCloseListener(org.emftext.language.xpath2.resource.xpath2.ui.Xpath2Editor editor) {
			this.editor = editor;
		}
		...
		public void partClosed(org.eclipse.ui.IWorkbenchPartReference partRef) {
			...
			if (workbenchPart instanceof org.emftext.language.xpath2.resource.xpath2.ui.Xpath2Editor) {
				org.emftext.language.xpath2.resource.xpath2.ui.Xpath2Editor editor = (org.emftext.language.xpath2.resource.xpath2.ui.Xpath2Editor) workbenchPart;
	 ...
	 */
	public Xpath2CodeFoldingManager(org.eclipse.jface.text.source.projection.ProjectionViewer sourceViewer,org.emftext.language.xpath2.resource.xpath2.ui.Xpath2Editor textEditor) {
	...
	private void addCloseListener(final org.emftext.language.xpath2.resource.xpath2.ui.Xpath2Editor editor) {
	...
	private java.io.File getCodeFoldingStateFile(String uriString) {
		org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle(org.emftext.language.xpath2.resource.xpath2.ui.Xpath2UIPlugin.PLUGIN_ID);
	...
	private String makeMD5(String text) {
		...
		try {
			...
			org.emftext.language.xpath2.resource.xpath2.ui.Xpath2UIPlugin.logError("NoSuchAlgorithmException while creating MD5 checksum.", e);
			return "";
		}
		String swap = "";
		String byteStr = "";
	...
	protected void calculatePositions() {
		org.emftext.language.xpath2.resource.xpath2.IXpath2TextResource textResource = (org.emftext.language.xpath2.resource.xpath2.IXpath2TextResource) editor.getResource();
		org.eclipse.jface.text.IDocument document = sourceViewer.getDocument();
