...
public class Xpath2OutlinePageTreeViewer extends org.eclipse.jface.viewers.TreeViewer {
	...
	public void setSelection(org.eclipse.jface.viewers.ISelection selection, boolean reveal) {
		...
		if (selection instanceof org.emftext.language.xpath2.resource.xpath2.ui.Xpath2EObjectSelection) {
	...
	public void expandToLevel(int level) {
		...
		try {
			...
			org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2Plugin.logError("Exception while refreshing outline view", e);
		}
	}
