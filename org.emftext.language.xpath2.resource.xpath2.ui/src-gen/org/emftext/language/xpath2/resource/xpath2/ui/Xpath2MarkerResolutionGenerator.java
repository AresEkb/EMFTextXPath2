...
public class Xpath2MarkerResolutionGenerator implements org.eclipse.ui.IMarkerResolutionGenerator {
		...
		try {
			...
			if (resource instanceof org.eclipse.core.resources.IFile) {
				...
				if (emfResource instanceof org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2Resource) {
					...
					java.util.Collection<org.emftext.language.xpath2.resource.xpath2.IXpath2QuickFix> quickFixes = getQuickFixes(customResource, marker);
	...
	public java.util.Collection<org.emftext.language.xpath2.resource.xpath2.IXpath2QuickFix> getQuickFixes(org.emftext.language.xpath2.resource.xpath2.IXpath2TextResource resource, org.eclipse.core.resources.IMarker marker) {
