 ...
 */
public class Xpath2IgnoredWordsFilter {
	...
	public boolean ignoreWord(String word) {
		...
		return org.emftext.language.xpath2.resource.xpath2.grammar.Xpath2GrammarInformationProvider.INSTANCE.getKeywords().contains(word);
	}
