 ...
 */
public class Xpath2CompletionProposal implements Comparable<Xpath2CompletionProposal> {
	
	/**
	 * The terminal that was expected at the cursor position.
	 */
	private org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal expectedTerminal;
	...
	public Xpath2CompletionProposal(org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container) {
		super();
	...
	public Xpath2CompletionProposal(org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image) {
		this(expectedTerminal, insertString, prefix, matchesPrefix, structuralFeature, container);
		this.image = image;
	}
	
	public Xpath2CompletionProposal(org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal expectedTerminal, String insertString, String prefix, boolean matchesPrefix, EStructuralFeature structuralFeature, EObject container, Image image, String displayString) {
	...
	public org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal getExpectedTerminal() {
		return expectedTerminal;
	}
	
	public boolean equals(Object object) {
		if (object instanceof Xpath2CompletionProposal) {
			Xpath2CompletionProposal other = (Xpath2CompletionProposal) object;
	...
	public int compareTo(Xpath2CompletionProposal object) {
		if (object instanceof Xpath2CompletionProposal) {
			Xpath2CompletionProposal other = (Xpath2CompletionProposal) object;
