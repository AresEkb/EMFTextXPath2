 ...
 */
public class Xpath2Hyperlink implements org.eclipse.jface.text.hyperlink.IHyperlink {
	 ...
	 */
	public Xpath2Hyperlink(org.eclipse.jface.text.IRegion region, org.eclipse.emf.ecore.EObject linkTarget, String targetText) {
		this.region = region;
	...
	public void open() {
		...
		if (file != null) {
			...
			try {
				...
				org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2Plugin.logError("Exception while opening hyperlink target.", e);
			}
		}
	}
