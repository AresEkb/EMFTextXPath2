 ...
 * @since 3.2
 */
public class Xpath2BrowserInformationControl extends org.eclipse.jface.text.AbstractInformationControl implements org.eclipse.jface.text.IInformationControlExtension2, org.eclipse.jface.text.IDelayedInputChangeProvider {
	...
	private org.emftext.language.xpath2.resource.xpath2.ui.Xpath2DocBrowserInformationControlInput fInput;
	 ...
	 */
	public Xpath2BrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public Xpath2BrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public Xpath2BrowserInformationControl(org.eclipse.swt.widgets.Shell parent, String symbolicFontName, org.eclipse.jface.action.ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		org.eclipse.core.runtime.Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.xpath2.resource.xpath2.ui.Xpath2DocBrowserInformationControlInput);
		...
		fInput= (org.emftext.language.xpath2.resource.xpath2.ui.Xpath2DocBrowserInformationControlInput) input;
		...
		org.emftext.language.xpath2.resource.xpath2.ui.Xpath2HTMLPrinter.insertStyles(buffer, styles);
	...
	public org.eclipse.swt.graphics.Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.xpath2.resource.xpath2.ui.Xpath2HTMLPrinter.html2text(new java.io.StringReader(fInput.getHtml()), presentation);
	 ...
	 */
	public org.emftext.language.xpath2.resource.xpath2.ui.Xpath2DocBrowserInformationControlInput getInput() {
		return fInput;
	}
