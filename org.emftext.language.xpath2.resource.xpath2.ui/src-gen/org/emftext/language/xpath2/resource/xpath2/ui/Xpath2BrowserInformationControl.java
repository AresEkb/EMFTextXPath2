...
public class Xpath2BrowserInformationControl extends AbstractInformationControl implements IInformationControlExtension2, IDelayedInputChangeProvider {
	 ...
	 */
	public Xpath2BrowserInformationControl(Shell parent, String symbolicFontName, boolean resizable) {
	 ...
	 */
	public Xpath2BrowserInformationControl(Shell parent, String symbolicFontName, String statusFieldText) {
	 ...
	 * @since 3.4
	 */
	public Xpath2BrowserInformationControl(Shell parent, String symbolicFontName, ToolBarManager toolBarManager) {
	...
	public void setInput(Object input) {
		Assert.isLegal(input == null || input instanceof String || input instanceof org.emftext.language.xpath2.resource.xpath2.ui.Xpath2DocBrowserInformationControlInput);
	...
	public Point computeSizeHint() {
		...
		String text;
		try {
			text = org.emftext.language.xpath2.resource.xpath2.ui.Xpath2HTMLPrinter.html2text(new StringReader(fInput.getHtml()), presentation);
		} catch (IOException e) {
			text = "";
		}
