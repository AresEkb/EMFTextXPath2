 ...
 */
public class Xpath2SyntaxColoringPreferencePage extends org.eclipse.jface.preference.PreferencePage implements org.eclipse.ui.IWorkbenchPreferencePage {
	...
	public Xpath2SyntaxColoringPreferencePage() {
		super();
	...
	private static class HighlightingColorListItem implements Comparable<HighlightingColorListItem> {
		...
		public HighlightingColorListItem(String languageID, String tokenName) {
			...
			fColorKey = org.emftext.language.xpath2.resource.xpath2.ui.Xpath2SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.xpath2.resource.xpath2.ui.Xpath2SyntaxColoringHelper.StyleProperty.COLOR);
			fBoldKey = org.emftext.language.xpath2.resource.xpath2.ui.Xpath2SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.xpath2.resource.xpath2.ui.Xpath2SyntaxColoringHelper.StyleProperty.BOLD);
			fItalicKey = org.emftext.language.xpath2.resource.xpath2.ui.Xpath2SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.xpath2.resource.xpath2.ui.Xpath2SyntaxColoringHelper.StyleProperty.ITALIC);
			fStrikethroughKey = org.emftext.language.xpath2.resource.xpath2.ui.Xpath2SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.xpath2.resource.xpath2.ui.Xpath2SyntaxColoringHelper.StyleProperty.STRIKETHROUGH);
			fUnderlineKey = org.emftext.language.xpath2.resource.xpath2.ui.Xpath2SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.xpath2.resource.xpath2.ui.Xpath2SyntaxColoringHelper.StyleProperty.UNDERLINE);
			fEnableKey = org.emftext.language.xpath2.resource.xpath2.ui.Xpath2SyntaxColoringHelper.getPreferenceKey(languageID, tokenName, org.emftext.language.xpath2.resource.xpath2.ui.Xpath2SyntaxColoringHelper.StyleProperty.ENABLE);
		}
	...
	private void addFiller(org.eclipse.swt.widgets.Composite composite, int horizontalSpan) {
		org.emftext.language.xpath2.resource.xpath2.ui.Xpath2PixelConverter pixelConverter = new org.emftext.language.xpath2.resource.xpath2.ui.Xpath2PixelConverter(composite);
	...
	private void updateActiveEditor() {
		...
		if (editor != null && editor instanceof org.emftext.language.xpath2.resource.xpath2.ui.Xpath2Editor) {
			org.emftext.language.xpath2.resource.xpath2.ui.Xpath2Editor emfTextEditor = (org.emftext.language.xpath2.resource.xpath2.ui.Xpath2Editor) editor;
