...
public class Xpath2NewFileWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard {
	
	private String categoryId = null;
	private org.emftext.language.xpath2.resource.xpath2.ui.Xpath2NewFileWizardPage page;
	...
	private java.io.InputStream openContentStream() {
		return new java.io.ByteArrayInputStream(new org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2MetaInformation().getNewFileContentProvider().getNewFileContent(newName).getBytes());
	}
