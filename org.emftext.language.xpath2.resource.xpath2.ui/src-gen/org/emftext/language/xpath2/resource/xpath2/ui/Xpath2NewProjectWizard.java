 ...
 */
public class Xpath2NewProjectWizard extends org.eclipse.jface.wizard.Wizard implements org.eclipse.ui.INewWizard, org.eclipse.core.runtime.IExecutableExtension {
	 ...
	 */
	private String pageName = "New " + new org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2MetaInformation().getSyntaxName() + " Project";
				...
				public void execute(org.eclipse.core.runtime.IProgressMonitor monitor) throws InterruptedException {
					try {
						...
						if (!project.exists()) {
							...
							org.osgi.framework.Bundle bundle = org.eclipse.core.runtime.Platform.getBundle("org.emftext.language.xpath2.resource.xpath2.ui");
							...
							String natureID = org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2Nature.NATURE_ID;
							...
							for (String builderID : org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2Nature.BUILDER_IDS) {
							...
							if (defaultNewFile.exists()) {
								org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2MetaInformation info = new org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2MetaInformation();
	...
	public void init(org.eclipse.ui.IWorkbench workbench, org.eclipse.jface.viewers.IStructuredSelection selection) {
		...
		org.osgi.framework.Bundle bundle = org.emftext.language.xpath2.resource.xpath2.ui.Xpath2UIPlugin.getDefault().getBundle();
