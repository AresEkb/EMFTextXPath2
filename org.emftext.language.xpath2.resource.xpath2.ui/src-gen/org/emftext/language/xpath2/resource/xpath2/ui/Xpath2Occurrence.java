 ...
 */
public class Xpath2Occurrence {
	
	private static interface ITokenScannerConstraint {
		public boolean mustStop(org.emftext.language.xpath2.resource.xpath2.ui.IXpath2TokenScanner tokenScanner);
	}
	
	public final static String OCCURRENCE_ANNOTATION_ID = "org.emftext.language.xpath2.resource.xpath2.ui.occurences";
	public final static String DECLARATION_ANNOTATION_ID = "org.emftext.language.xpath2.resource.xpath2.ui.occurences.declaration";
	 ...
	 */
	public Xpath2Occurrence(org.emftext.language.xpath2.resource.xpath2.IXpath2TextResource textResource, ProjectionViewer projectionViewer) {
		super();
	...
	protected int getLength(org.emftext.language.xpath2.resource.xpath2.IXpath2LocationMap locationMap, EObject eObject) {
	...
	public void updateOccurrenceAnnotations() {
		...
		org.emftext.language.xpath2.resource.xpath2.ui.IXpath2TokenScanner tokenScanner = scan(referencedElement, new ITokenScannerConstraint() {
	...
	protected void addAnnotationsForReferences(EObject referencedElement, List<String> matchingNames) {
		...
		for (Setting setting : referencingObjects) {
			...
			for (String name : matchingNames) {
				...
				if (index > 0) {
					addAnnotation(document, org.emftext.language.xpath2.resource.xpath2.ui.Xpath2PositionCategory.PROXY, name, index, name.length());
				}
			}
		}
	}
	...
	protected List<String> addAnnotationsForDefinition(EObject referencedElement, String definitionText, int definitionOffset, final int caretOffset) {
		...
		if (definitionText == null) {
			...
			final List<String> names = new org.emftext.language.xpath2.resource.xpath2.analysis.Xpath2DefaultNameProvider().getNames(referencedElement);
			scan(referencedElement, new ITokenScannerConstraint() {
				...
				public boolean mustStop(org.emftext.language.xpath2.resource.xpath2.ui.IXpath2TokenScanner tokenScanner) {
					...
					if (names.contains(text) && isContainedIn(offset, length, caretOffset)) {
						...
						addAnnotation(document, org.emftext.language.xpath2.resource.xpath2.ui.Xpath2PositionCategory.DEFINITION, text, offset, text.length());
					}
					return false;
				}
			});
			...
			addAnnotation(document, org.emftext.language.xpath2.resource.xpath2.ui.Xpath2PositionCategory.DEFINITION, definitionText, definitionOffset, definitionText.length());
	...
	protected int getIndexOf(EObject eObject, final String text) {
		org.emftext.language.xpath2.resource.xpath2.ui.IXpath2TokenScanner tokenScanner = scan(eObject, new ITokenScannerConstraint() {
	...
	protected org.emftext.language.xpath2.resource.xpath2.ui.IXpath2TokenScanner scan(EObject object, ITokenScannerConstraint constraint) {
		IDocument document = getSourceViewer().getDocument();
		
		org.emftext.language.xpath2.resource.xpath2.IXpath2LocationMap locationMap = textResource.getLocationMap();
		
		org.emftext.language.xpath2.resource.xpath2.ui.IXpath2TokenScanner tokenScanner = createTokenScanner();
	...
	protected org.emftext.language.xpath2.resource.xpath2.ui.IXpath2TokenScanner createTokenScanner() {
		return new org.emftext.language.xpath2.resource.xpath2.ui.Xpath2UIMetaInformation().createTokenScanner(null, null);
	}
	
	protected void addAnnotation(IDocument document, org.emftext.language.xpath2.resource.xpath2.ui.Xpath2PositionCategory type, String text, int offset, int length) {
		...
		if (type == org.emftext.language.xpath2.resource.xpath2.ui.Xpath2PositionCategory.DEFINITION) {
	...
	protected void removeAnnotations() {
		removeAnnotations(org.emftext.language.xpath2.resource.xpath2.ui.Xpath2Occurrence.OCCURRENCE_ANNOTATION_ID);
		removeAnnotations(org.emftext.language.xpath2.resource.xpath2.ui.Xpath2Occurrence.DECLARATION_ANNOTATION_ID);
	}
