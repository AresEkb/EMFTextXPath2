 ...
 */
public class Xpath2OutlinePage extends Page implements ISelectionProvider, ISelectionChangedListener, IContentOutlinePage {
	
	public final static String CONTEXT_MENU_ID = "org.emftext.language.xpath2.resource.xpath2.ui.outlinecontext";
	...
	public Xpath2OutlinePage(org.emftext.language.xpath2.resource.xpath2.IXpath2ResourceProvider resourceProvider) {
		super();
		this.resourceProvider = resourceProvider;
	}
	
	public void createControl(Composite parent) {
		treeViewer = new org.emftext.language.xpath2.resource.xpath2.ui.Xpath2OutlinePageTreeViewer(parent, SWT.MULTI | SWT.H_SCROLL | SWT.V_SCROLL);
				...
				if (viewer != null && viewer.getControl() != null && !viewer.getControl().isDisposed()) {
					viewerRefresh = new ViewerRefresh(viewer) {
						...
						protected void refresh(IViewerNotification notification) {
							if (viewer instanceof org.emftext.language.xpath2.resource.xpath2.ui.Xpath2OutlinePageTreeViewer) {
								org.emftext.language.xpath2.resource.xpath2.ui.Xpath2OutlinePageTreeViewer pageTreeViewer = (org.emftext.language.xpath2.resource.xpath2.ui.Xpath2OutlinePageTreeViewer) viewer;
		...
		treeViewer.setComparator(new org.emftext.language.xpath2.resource.xpath2.ui.Xpath2OutlinePageTreeViewerComparator());
		createContextMenu();
		createActions();
	}
	...
	private void createContextMenu() {
		...
		getSite().registerContextMenu("org.emftext.language.xpath2.resource.xpath2.ui.outlinecontext", menuManager, treeViewer);
	}
	...
	private void createActions() {
		...
		List<IAction> actions = new org.emftext.language.xpath2.resource.xpath2.ui.Xpath2OutlinePageActionProvider().getActions(treeViewer);
