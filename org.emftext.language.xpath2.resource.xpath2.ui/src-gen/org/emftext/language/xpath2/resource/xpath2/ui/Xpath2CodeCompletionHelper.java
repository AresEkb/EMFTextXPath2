...
public class Xpath2CodeCompletionHelper {
	...
	public org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal[] computeCompletionProposals(org.emftext.language.xpath2.resource.xpath2.IXpath2TextResource originalResource, String content, int cursorOffset) {
		...
		java.util.List<org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal> expectedAfterCursor = java.util.Arrays.asList(getElementsExpectedAt(expectedElements, cursorOffset));
		java.util.List<org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal> expectedBeforeCursor = java.util.Arrays.asList(getElementsExpectedAt(expectedElements, cursorOffset - 1));
		...
		java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> allProposals = new java.util.LinkedHashSet<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal>();
		java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> rightProposals = deriveProposals(expectedAfterCursor, content, resource, cursorOffset);
		java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> leftProposals = deriveProposals(expectedBeforeCursor, content, resource, cursorOffset - 1);
		...
		final java.util.List<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> sortedProposals = new java.util.ArrayList<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal>(allProposals);
	...
	public org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal[] parseToExpectedElements(org.emftext.language.xpath2.resource.xpath2.IXpath2TextParser parser, org.emftext.language.xpath2.resource.xpath2.IXpath2TextResource resource, int cursorOffset) {
		final java.util.List<org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal> expectedElements = parser.parseToExpectedElements(null, resource, cursorOffset);
		if (expectedElements == null) {
	 ...
	 * the same position.
	 */
	protected void removeDuplicateEntries(java.util.List<org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal> expectedElements) {
		...
		java.util.Map<Integer, java.util.List<org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal>> map = new java.util.LinkedHashMap<Integer, java.util.List<org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal>>();
		for (int i = 0; i < size; i++) {
			...
			java.util.List<org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal> list = map.get(start1);
			if (list == null) {
				list = new java.util.ArrayList<org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal>();
				map.put(start1, list);
			}
		...
		for (int position : map.keySet()) {
			java.util.List<org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal> list = map.get(position);
	 ...
	 */
	protected void removeDuplicateEntriesFromBucket(java.util.List<org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal> expectedElements) {
		int size = expectedElements.size();
	...
	protected void removeInvalidEntriesAtEnd(java.util.List<org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal> expectedElements) {
	 ...
	 */
	protected void removeKeywordsEndingBeforeIndex(java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> proposals, int index) {
	...
	protected String findPrefix(java.util.List<org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal> expectedElements, org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal expectedAtCursor, String content, int cursorOffset) {
		if (cursorOffset < 0) {
			return "";
		}
		int end = 0;
	...
	protected java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> deriveProposals(java.util.List<org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal> expectedElements, String content, org.emftext.language.xpath2.resource.xpath2.IXpath2TextResource resource, int cursorOffset) {
		java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> resultSet = new java.util.LinkedHashSet<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal>();
		for (org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal expectedElement : expectedElements) {
	...
	protected java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> deriveProposals(final org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal expectedTerminal, String content, org.emftext.language.xpath2.resource.xpath2.IXpath2TextResource resource, int cursorOffset) {
		...
		if (expectedElement instanceof org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedCsString) {
			...
			// completed.
			final java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> proposals = new java.util.ArrayList<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal>();
	...
	protected java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> handleEnumAttribute(org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal expectedTerminal, org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedStructuralFeature expectedFeature, org.eclipse.emf.ecore.EEnum enumType, String prefix, org.eclipse.emf.ecore.EObject container) {
		java.util.Collection<org.eclipse.emf.ecore.EEnumLiteral> enumLiterals = enumType.getELiterals();
		java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> result = new java.util.LinkedHashSet<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal>();
	...
	protected java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> handleNCReference(org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal expectedTerminal, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EReference reference, String prefix, String tokenName) {
		...
		org.emftext.language.xpath2.resource.xpath2.IXpath2TokenResolverFactory tokenResolverFactory = metaInformation.getTokenResolverFactory();
		org.emftext.language.xpath2.resource.xpath2.IXpath2ReferenceResolveResult<org.eclipse.emf.ecore.EObject> result = new org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ReferenceResolveResult<org.eclipse.emf.ecore.EObject>(true);
		resolverSwitch.resolveFuzzy(prefix, container, reference, 0, result);
		java.util.Collection<org.emftext.language.xpath2.resource.xpath2.IXpath2ReferenceMapping<org.eclipse.emf.ecore.EObject>> mappings = result.getMappings();
		if (mappings != null) {
			java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> resultSet = new java.util.LinkedHashSet<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal>();
			for (org.emftext.language.xpath2.resource.xpath2.IXpath2ReferenceMapping<org.eclipse.emf.ecore.EObject> mapping : mappings) {
				...
				if (mapping instanceof org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ElementMapping<?>) {
					...
					resultSet.add(new org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal(expectedTerminal, identifier, prefix, matchesPrefix, reference, container, image));
				}
			}
			return resultSet;
		}
	...
	protected java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> handleAttribute(org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal expectedTerminal, org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedStructuralFeature expectedFeature, org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EAttribute attribute, String prefix) {
		java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> resultSet = new java.util.LinkedHashSet<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal>();
	 ...
	 */
	protected java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> handleKeyword(org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal expectedTerminal, org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedCsString csString, String prefix) {
		String proposal = csString.getValue();
		boolean matchesPrefix = matches(proposal, prefix);
		return java.util.Collections.singleton(new org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal(expectedTerminal, proposal, prefix, matchesPrefix, null, null));
	}
	
	/**
	 * Creates a set of (two) completion proposals from the given boolean terminal.
	 */
	protected java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> handleBooleanTerminal(org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal expectedTerminal, org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedBooleanTerminal expectedBooleanTerminal, String prefix) {
		java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> result = new java.util.LinkedHashSet<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal>(2);
	 ...
	 */
	protected java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> handleEnumerationTerminal(org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal expectedTerminal, org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedEnumerationTerminal expectedEnumerationTerminal, String prefix) {
		java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> result = new java.util.LinkedHashSet<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal>(2);
	...
	protected java.util.Collection<org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal> handleLiteral(org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal expectedTerminal, org.eclipse.emf.ecore.EAttribute attribute, String prefix, String literal) {
		if ("".equals(literal)) {
			return java.util.Collections.emptySet();
		}
		boolean matchesPrefix = matches(literal, prefix);
		return java.util.Collections.singleton(new org.emftext.language.xpath2.resource.xpath2.ui.Xpath2CompletionProposal(expectedTerminal, literal, prefix, matchesPrefix, null, null));
	}
	 ...
	 * element is expected.
	 */
	protected void setPrefixes(java.util.List<org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal> expectedElements, String content, int cursorOffset) {
		if (cursorOffset < 0) {
			return;
		}
		for (org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal expectedElement : expectedElements) {
	...
	public org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal[] getElementsExpectedAt(org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal[] allExpectedElements, int cursorOffset) {
		java.util.List<org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal> expectedAtCursor = new java.util.ArrayList<org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal>();
	...
	protected org.eclipse.emf.ecore.EObject findCorrectContainer(org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ExpectedTerminal expectedTerminal) {
	 ...
	 */
	protected org.eclipse.emf.ecore.EObject findHookParent(org.eclipse.emf.ecore.EObject container, org.eclipse.emf.ecore.EClass startClass, org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2ContainedFeature currentLink, org.eclipse.emf.ecore.EObject object) {
		org.eclipse.emf.ecore.EClass containerClass = currentLink.getContainerClass();
