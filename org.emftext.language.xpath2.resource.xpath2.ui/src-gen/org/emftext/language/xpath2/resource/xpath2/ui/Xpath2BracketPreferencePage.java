 ...
 * </p>
 */
public class Xpath2BracketPreferencePage extends PreferencePage implements IWorkbenchPreferencePage {
	...
	public void init(IWorkbench workbench) {
		...
		bracketsTmp = new org.emftext.language.xpath2.resource.xpath2.ui.Xpath2BracketSet();
	...
	private void handleMatchingBracketsSelection() {
		...
		initializeLanguage();
		bracketsTmp.deserialize(getPreferenceStore().getString(language + org.emftext.language.xpath2.resource.xpath2.ui.Xpath2PreferenceConstants.EDITOR_BRACKETS_SUFFIX));
	...
	private void addListenersToStyleButtons() {
		...
		bracketsList.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				org.emftext.language.xpath2.resource.xpath2.IXpath2BracketPair bracketPair = getSelectedBracketPair();
				if (bracketPair == null) {
					removeBracketButton.setEnabled(false);
					return;
				}
	...
	protected void performDefaults() {
		...
		enableCheckbox.setSelection(preferenceStore.getDefaultBoolean(org.emftext.language.xpath2.resource.xpath2.ui.Xpath2PreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX));
		matchingBracketsColorButton.setEnabled(enableCheckbox.getSelection());
		matchingBracketsColorEditor.setColorValue(PreferenceConverter.getDefaultColor(preferenceStore, BRACKETS_COLOR));
		String defaultBrackets = preferenceStore.getDefaultString(language + org.emftext.language.xpath2.resource.xpath2.ui.Xpath2PreferenceConstants.EDITOR_BRACKETS_SUFFIX);
	...
	private void updateActiveEditor() {
		...
		preferenceStore.setValue(org.emftext.language.xpath2.resource.xpath2.ui.Xpath2PreferenceConstants.EDITOR_MATCHING_BRACKETS_CHECKBOX, enableCheckbox.getSelection());
		preferenceStore.setValue(language + org.emftext.language.xpath2.resource.xpath2.ui.Xpath2PreferenceConstants.EDITOR_BRACKETS_SUFFIX, bracketSetTemp.get(language));
	...
	protected org.emftext.language.xpath2.resource.xpath2.IXpath2BracketPair getSelectedBracketPair() {
