 ...
 */
public class Xpath2NewFileWizardPage extends org.eclipse.jface.wizard.WizardPage {
	 ...
	 */
	public Xpath2NewFileWizardPage(org.eclipse.jface.viewers.ISelection selection, String fileExtension) {
		super("wizardPage");
		setTitle("Create new xpath2 file");
