...
/**
 * The Xpath2AutoEditStrategy extends the default auto edit strategy such that an
 ...
 */
public class Xpath2AutoEditStrategy extends DefaultIndentLineAutoEditStrategy {
	
	private org.emftext.language.xpath2.resource.xpath2.ui.Xpath2BracketSet bracketSet;
	
	public Xpath2AutoEditStrategy() {
		super();
		...
		if (plugin != null) {
			...
			bracketSet = new org.emftext.language.xpath2.resource.xpath2.ui.Xpath2BracketSet();
	 ...
	 */
	@Deprecated
	public void setBracketSet(org.emftext.language.xpath2.resource.xpath2.ui.Xpath2BracketSet bracketSet) {
