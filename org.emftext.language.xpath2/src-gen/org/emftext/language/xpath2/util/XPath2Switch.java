...
public class XPath2Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case XPath2Package.STEP_EXPR_CHILD: {
				StepExprChild stepExprChild = (StepExprChild)theEObject;
				T result = caseStepExprChild(stepExprChild);
				if (result == null) result = casePathExprChild(stepExprChild);
				if (result == null) result = caseUnaryExprChild(stepExprChild);
				if (result == null) result = caseCastExprChild(stepExprChild);
				if (result == null) result = caseCastableExprChild(stepExprChild);
				if (result == null) result = caseTreatExprChild(stepExprChild);
				if (result == null) result = caseInstanceofExprChild(stepExprChild);
				if (result == null) result = caseIntersectExceptExprChild(stepExprChild);
				if (result == null) result = caseUnionExprChild(stepExprChild);
				if (result == null) result = caseMultiplicativeExprChild(stepExprChild);
				if (result == null) result = caseAdditiveExprChild(stepExprChild);
				if (result == null) result = caseRangeExprChild(stepExprChild);
				if (result == null) result = caseComparisonExprChild(stepExprChild);
				if (result == null) result = caseAndExprChild(stepExprChild);
				if (result == null) result = caseOrExprChild(stepExprChild);
				if (result == null) result = caseExprSingle(stepExprChild);
				if (result == null) result = caseAnyExpr(stepExprChild);
				if (result == null) result = caseParenthesizedExprChild(stepExprChild);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case XPath2Package.STEP_EXPR: {
				...
				if (result == null) result = caseStepExprChild(stepExpr);
			...
			case XPath2Package.FILTER_EXPR: {
				...
				if (result == null) result = caseStepExprChild(filterExpr);
			...
			case XPath2Package.FILTER_EXPR_CHILD: {
				...
				if (result == null) result = caseStepExprChild(filterExprChild);
			...
			case XPath2Package.AXIS_STEP: {
				...
				if (result == null) result = caseStepExprChild(axisStep);
			...
			case XPath2Package.FORWARD_STEP: {
				...
				if (result == null) result = caseStepExprChild(forwardStep);
			...
			case XPath2Package.REVERSE_STEP: {
				...
				if (result == null) result = caseStepExprChild(reverseStep);
			...
			case XPath2Package.GENERAL_FORWARD_STEP: {
				...
				if (result == null) result = caseStepExprChild(generalForwardStep);
			...
			case XPath2Package.ABBREV_FORWARD_STEP: {
				...
				if (result == null) result = caseStepExprChild(abbrevForwardStep);
			...
			case XPath2Package.GENERAL_REVERSE_STEP: {
				...
				if (result == null) result = caseStepExprChild(generalReverseStep);
			...
			case XPath2Package.ABBREV_REVERSE_STEP: {
				...
				if (result == null) result = caseStepExprChild(abbrevReverseStep);
			...
			case XPath2Package.PRIMARY_EXPR: {
				...
				if (result == null) result = caseStepExprChild(primaryExpr);
			...
			case XPath2Package.LITERAL: {
				...
				if (result == null) result = caseStepExprChild(literal);
			...
			case XPath2Package.VAR_REF: {
				...
				if (result == null) result = caseStepExprChild(varRef);
			...
			case XPath2Package.PARENTHESIZED_EXPR: {
				...
				if (result == null) result = caseStepExprChild(parenthesizedExpr);
			...
			case XPath2Package.CONTEXT_ITEM_EXPR: {
				...
				if (result == null) result = caseStepExprChild(contextItemExpr);
			...
			case XPath2Package.FUNCTION_CALL: {
				...
				if (result == null) result = caseStepExprChild(functionCall);
			...
			case XPath2Package.NUMERIC_LITERAL: {
				...
				if (result == null) result = caseStepExprChild(numericLiteral);
			...
			case XPath2Package.STRING_LITERAL: {
				...
				if (result == null) result = caseStepExprChild(stringLiteral);
			...
			case XPath2Package.INTEGER_LITERAL: {
				...
				if (result == null) result = caseStepExprChild(integerLiteral);
			...
			case XPath2Package.DECIMAL_LITERAL: {
				...
				if (result == null) result = caseStepExprChild(decimalLiteral);
			...
			case XPath2Package.DOUBLE_LITERAL: {
				...
				if (result == null) result = caseStepExprChild(doubleLiteral);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Step Expr Child</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Step Expr Child</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStepExprChild(StepExprChild object) {
		return null;
	}
