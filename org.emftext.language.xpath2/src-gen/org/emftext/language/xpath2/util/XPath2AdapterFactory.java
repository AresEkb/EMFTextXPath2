...
public class XPath2AdapterFactory extends AdapterFactoryImpl {
    ...
    protected XPath2Switch<Adapter> modelSwitch =
        new XPath2Switch<Adapter>() {
            ...
            @Override
            public Adapter caseStepExprChild(StepExprChild object) {
                return createStepExprChildAdapter();
            }
            @Override
    ...
    /**
     * Creates a new adapter for an object of class '{@link org.emftext.language.xpath2.StepExprChild <em>Step Expr Child</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createStepExprChildAdapter() {
        return null;
    }
