 ...
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.xpath2.impl.CastableExprImpl#getOperand <em>Operand</em>}</li>
 *   <li>{@link org.emftext.language.xpath2.impl.CastableExprImpl#getType <em>Type</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CastableExprImpl extends TreatExprChildImpl implements CastableExpr {
    ...
    public NotificationChain basicSetOperand(CastableExprChild newOperand, NotificationChain msgs) {
        ...
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XPath2Package.CASTABLE_EXPR__OPERAND, oldOperand, newOperand);
    ...
    public void setOperand(CastableExprChild newOperand) {
        if (newOperand != operand) {
            ...
            if (operand != null)
                msgs = ((InternalEObject)operand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XPath2Package.CASTABLE_EXPR__OPERAND, null, msgs);
            if (newOperand != null)
                msgs = ((InternalEObject)newOperand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XPath2Package.CASTABLE_EXPR__OPERAND, null, msgs);
    ...
    public NotificationChain basicSetType(SingleType newType, NotificationChain msgs) {
        ...
        type = newType;
        if (eNotificationRequired()) {
            ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XPath2Package.CASTABLE_EXPR__TYPE, oldType, newType);
            if (msgs == null) msgs = notification; else msgs.add(notification);
        }
        return msgs;
    }
    ...
    public void setType(SingleType newType) {
        if (newType != type) {
            NotificationChain msgs = null;
            if (type != null)
                msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XPath2Package.CASTABLE_EXPR__TYPE, null, msgs);
            if (newType != null)
                msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XPath2Package.CASTABLE_EXPR__TYPE, null, msgs);
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            ...
            case XPath2Package.CASTABLE_EXPR__TYPE:
