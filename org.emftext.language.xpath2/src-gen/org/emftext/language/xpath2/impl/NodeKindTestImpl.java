 ...
 * </p>
 * <ul>
 *   <li>{@link org.emftext.language.xpath2.impl.NodeKindTestImpl#getTest <em>Test</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NodeKindTestImpl extends NodeTestImpl implements NodeKindTest {
	...
	public NotificationChain basicSetTest(KindTest newTest, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XPath2Package.NODE_KIND_TEST__TEST, oldTest, newTest);
	...
	public void setTest(KindTest newTest) {
		if (newTest != test) {
			...
			if (test != null)
				msgs = ((InternalEObject)test).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XPath2Package.NODE_KIND_TEST__TEST, null, msgs);
			if (newTest != null)
				msgs = ((InternalEObject)newTest).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XPath2Package.NODE_KIND_TEST__TEST, null, msgs);
