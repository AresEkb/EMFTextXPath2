...
public class XPath2PackageImpl extends EPackageImpl implements XPath2Package {
     ...
     * @generated
     */
    private EClass stepExprChildEClass = null;
     ...
     * @generated
     */
    public EClass getStepExprChild() {
        return stepExprChildEClass;
    }
     ...
     * @generated
     */
    public EReference getStepExpr_Predicate() {
    ...
    public void createPackageContents() {
        ...
        stepExprChildEClass = createEClass(STEP_EXPR_CHILD);

        stepExprEClass = createEClass(STEP_EXPR);
        createEReference(stepExprEClass, STEP_EXPR__PREDICATE);
    ...
    public void initializePackageContents() {
        ...
        stepExprChildEClass.getESuperTypes().add(this.getPathExprChild());
        stepExprEClass.getESuperTypes().add(this.getStepExprChild());
        filterExprEClass.getESuperTypes().add(this.getStepExpr());
        filterExprChildEClass.getESuperTypes().add(this.getStepExprChild());
        ...
        initEReference(getChildStepExpr_Step(), this.getStepExprChild(), null, "step", null, 1, 1, ChildStepExpr.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getDescOrSelfStepExpr_Step(), this.getStepExprChild(), null, "step", null, 1, 1, DescOrSelfStepExpr.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(selfStepExprEClass, SelfStepExpr.class, "SelfStepExpr", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getSelfStepExpr_Step(), this.getStepExprChild(), null, "step", null, 1, 1, SelfStepExpr.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(stepExprChildEClass, StepExprChild.class, "StepExprChild", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

        initEClass(stepExprEClass, StepExpr.class, "StepExpr", IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getStepExpr_Predicate(), this.getPredicate(), null, "predicate", null, 0, -1, StepExpr.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
