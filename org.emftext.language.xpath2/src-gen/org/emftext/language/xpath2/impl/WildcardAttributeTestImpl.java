...
public class WildcardAttributeTestImpl extends AttributeTestImpl implements WildcardAttributeTest {
   ...
   */
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpath2Package.WILDCARD_ATTRIBUTE_TEST__TYPE, oldType, newType);
   ...
   */
    ...
    if (newType != type)
    {
      ...
      if (type != null)
        msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpath2Package.WILDCARD_ATTRIBUTE_TEST__TYPE, null, msgs);
      if (newType != null)
        msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpath2Package.WILDCARD_ATTRIBUTE_TEST__TYPE, null, msgs);
