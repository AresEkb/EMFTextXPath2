...
public class SchemaAttributeTestImpl extends KindTestImpl implements SchemaAttributeTest {
   ...
   */
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Xpath2Package.SCHEMA_ATTRIBUTE_TEST__NAME, oldName, newName);
   ...
   */
    ...
    if (newName != name)
    {
      ...
      if (name != null)
        msgs = ((InternalEObject)name).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Xpath2Package.SCHEMA_ATTRIBUTE_TEST__NAME, null, msgs);
      if (newName != null)
        msgs = ((InternalEObject)newName).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Xpath2Package.SCHEMA_ATTRIBUTE_TEST__NAME, null, msgs);
      msgs = basicSetName(newName, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Xpath2Package.SCHEMA_ATTRIBUTE_TEST__NAME, newName, newName));
  }
