...
public class Xpath2DebugValue extends org.emftext.language.xpath2.resource.xpath2.debug.Xpath2DebugElement implements IValue {
	...
	public Xpath2DebugValue(org.emftext.language.xpath2.resource.xpath2.debug.Xpath2DebugTarget target, String id, String valueString, String referenceTypeName, Map<String, Long> children) {
		super(target);
