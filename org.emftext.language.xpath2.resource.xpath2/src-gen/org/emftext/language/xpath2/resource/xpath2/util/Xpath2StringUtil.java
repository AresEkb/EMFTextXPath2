...
public class Xpath2StringUtil {
	 ...
	 * is used to convert the parts to strings.
	 */
	public static <T> String explode(T[] parts, String glue, org.emftext.language.xpath2.resource.xpath2.IXpath2Function1<String, T> toStringFunction) {
