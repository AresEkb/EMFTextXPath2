 ...
 * Xpath2TaskItemDetector is used both by the TaskItemBuilder and the editor.
 */
public class Xpath2TaskItemDetector {
	...
	public List<org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2TaskItem> findTaskItems(String text, int line, int charStart) {
		List<org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2TaskItem> foundItems = new ArrayList<org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2TaskItem>();
		...
		while (remainingText != null && continueSearch) {
			...
			for (String keyword : TASK_ITEM_KEYWORDS) {
				...
				if (index >= 0) {
					...
					foundItems.add(new org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2TaskItem(keyword, message, localLine, offset, end));
