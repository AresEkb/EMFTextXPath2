	...
	public static <K> void putAndMergeKeys(java.util.Map<K, Object> map, K key, Object value) {
		...
		if (map.containsKey(key)) {
			...
			if (currentValue instanceof java.util.List<?>) {
				...
				java.util.List<Object> currentValueAsObjectList = org.emftext.language.xpath2.resource.xpath2.util.Xpath2ListUtil.copySafelyToObjectList(currentValueAsList);
