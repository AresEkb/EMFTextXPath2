...
public class Xpath2Nature implements org.eclipse.core.resources.IProjectNature {
	
	public static final String NATURE_ID = "org.emftext.language.xpath2.resource.xpath2.nature";
	 ...
	 */
	public final static String[] BUILDER_IDS = {org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2BuilderAdapter.BUILDER_ID};
	...
	public void configure() throws org.eclipse.core.runtime.CoreException {
		...
		for (int i = 0; i < commands.length; ++i) {
			if (commands[i].getBuilderName().equals(org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2BuilderAdapter.BUILDER_ID)) {
				return;
			}
		}
