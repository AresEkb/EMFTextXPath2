...
public class AbstractXpath2Interpreter<ResultType, ContextType> {
	...
	public ResultType interprete(org.eclipse.emf.ecore.EObject object, ContextType context) {
		...
		if (object instanceof org.emftext.language.xpath2.SinglePathSeparator) {
			result = interprete_org_emftext_language_xpath2_SinglePathSeparator((org.emftext.language.xpath2.SinglePathSeparator) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof org.emftext.language.xpath2.DoublePathSeparator) {
			result = interprete_org_emftext_language_xpath2_DoublePathSeparator((org.emftext.language.xpath2.DoublePathSeparator) object, context);
		}
		if (result != null) {
			return result;
		}
		if (object instanceof org.emftext.language.xpath2.PathSeparator) {
			result = interprete_org_emftext_language_xpath2_PathSeparator((org.emftext.language.xpath2.PathSeparator) object, context);
		}
		if (result != null) {
			return result;
		}
	...
	public ResultType interprete_org_emftext_language_xpath2_PathSeparator(org.emftext.language.xpath2.PathSeparator pathSeparator, ContextType context) {
		return null;
	}
	
	public ResultType interprete_org_emftext_language_xpath2_SinglePathSeparator(org.emftext.language.xpath2.SinglePathSeparator singlePathSeparator, ContextType context) {
		return null;
	}
	
	public ResultType interprete_org_emftext_language_xpath2_DoublePathSeparator(org.emftext.language.xpath2.DoublePathSeparator doublePathSeparator, ContextType context) {
		return null;
	}
