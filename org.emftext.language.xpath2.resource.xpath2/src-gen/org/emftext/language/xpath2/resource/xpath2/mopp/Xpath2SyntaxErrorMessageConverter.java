...
public class Xpath2SyntaxErrorMessageConverter {
	
	private String[] tokenNames;
	
	public Xpath2SyntaxErrorMessageConverter(String[] tokenNames) {
	 ...
	 */
	public org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2LocalizedMessage translateLexicalError(RecognitionException e, List<RecognitionException> lexerExceptions, List<Integer> lexerExceptionPositions)  {
		String message = getMessage(e);
		return new org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2LocalizedMessage(message, e.charPositionInLine, e.line, lexerExceptionPositions.get(lexerExceptions.indexOf(e)), lexerExceptionPositions.get(lexerExceptions.indexOf(e)));
	}
	
	/**
	 * Translates errors thrown by the parser into human readable messages.
	 */
	public org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2LocalizedMessage translateParseError(RecognitionException e)  {
		String message = getMessage(e);
		
		if (e.token instanceof CommonToken) {
			CommonToken ct = (CommonToken) e.token;
			return new org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2LocalizedMessage(message, ct.getCharPositionInLine(), ct.getLine(), ct.getStartIndex(), ct.getStopIndex());
		} else {
			int position = 1;
			int line = 1;
			if (e.token != null) {
			...
			return new org.emftext.language.xpath2.resource.xpath2.mopp.Xpath2LocalizedMessage(message, position, line, 1, 5);
		}
	}
